...
var PATTERN = new RegExp("^\\s*(på|efter|före|på|,|-|\\(|\\))?\\s*$");
...
function isAbleToMerge(text, prevResult, currResult) {
    ...
    var includesRelativeResult = (prevResult.tags['SVRelativeDateFormatParser'] || currResult.tags['SVRelativeDateFormatParser']);
...
function mergeResult(text, specificResult, nonSpecificResult){
    ...
    specificResult.tags['SVPrioritizeSpecificDateRefiner'] = true;
    return specificResult;
}

exports.Refiner = function SVPrioritizeSpecificDateRefiner() {
    Refiner.call(this);
