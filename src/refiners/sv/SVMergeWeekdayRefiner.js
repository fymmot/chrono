...
var PATTERN = new RegExp("\\s*('s|på)?\\s*");

var WEEK_TAG = 'SVWeekExpressionParser';
var WEEK_DAY_TAG = 'SVDayOfWeekDateFormatParser';

exports.Refiner = function SVMergeDateRangeRefiner() {
	Refiner.call(this);
