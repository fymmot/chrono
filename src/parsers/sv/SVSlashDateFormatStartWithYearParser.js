/*
    Date format with slash "/" between numbers like SVSlashDateFormatParser,
...
exports.Parser = function SVSlashDateFormatStartWithYearParser(){
    ...
    this.extract = function(text, ref, match, opt){
        ...
        result.tags['SVDateFormatParser'] = true;
        return result;
    };
}
